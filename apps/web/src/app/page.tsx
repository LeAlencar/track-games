      ...
      <main className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Descubra novos jogos, organize sua biblioteca, acompanhe seu
            progresso e conecte-se com outros gamers. Tudo em uma plataforma
            moderna e intuitiva.
          </p>
              ...
              <>
                ...
                <Link href="/login">
                  <Button
                    size="lg"
                    variant="outline"
                    className="text-white border-white hover:bg-white hover:text-orange-900 text-lg px-8 py-6"
                  >
                    Já tenho conta
                  </Button>
                </Link>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-gray-300">
                  Organize seus jogos por status, plataforma, gênero e muito
                  mais. Nunca mais perca um jogo na sua coleção.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-gray-300">
                  Acompanhe suas horas jogadas, progresso, conquistas e muito
                  mais. Veja sua evolução como gamer.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-gray-300">
                  Explore milhares de jogos, leia reviews da comunidade e
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-gray-300">
                  Desbloqueie conquistas especiais e acompanhe seus marcos como
                  gamer. Compartilhe suas vitórias.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="mt-32 text-center">
          <div className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 rounded-2xl p-12 border border-orange-500/30">
            ...
            <p className="text-gray-300 text-lg mb-8">
              Junte-se a milhares de gamers que já organizaram suas bibliotecas
              com o Ludexicon
            </p>
            {!isAuthenticated && (
              <Link href="/signup">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardContent className="p-12">
                ...
                <p className="text-gray-300 text-lg mb-8">
                  Tem alguma dúvida ou sugestão? Envie-nos um e-mail!
                </p>
                <a href="mailto:contato@ludexicon.com?subject=Contato%20via%20Site">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-lg px-8 py-6"
                  >
                    <Mail className="mr-2 w-5 h-5" />
                    contato@ludexicon.com
                  </Button>
                </a>
              </CardContent>
            </Card>
